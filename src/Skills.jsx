...
const Skills = ({ darkMode }) => {
  const skills = [
    { name: 'JavaScript', icon: javascript, level: 60, color: 'from-orange-500 to-amber-500' },
    { name: 'Java', icon: java, level: 80, color: 'from-red-500 to-yellow-500' },
    { name: 'Python', icon: python, level: 50, color: 'from-blue-500 to-cyan-500' },
    { name: 'PHP', icon: php, level: 60, color: 'from-orange-500 to-amber-500' },
  ]
      ...
      <div className="container px-5 py-14 mx-auto">
        ...
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          >
            ...
            <span
              style={{
                background: 'linear-gradient(to right, #f97316, #59e3c2)',
          ...
          >
            I’m a backend-focused student developing server-side skills through projects, practice, and continuous learning.
          </p>
        </div>
        ...
        <div className="flex flex-wrap -m-4" data-aos="fade-up" data-aos-delay="200">
          {skills.map((skill, index) => (
            ...
            >
              {/* ✅ CARD (everything inside this box) */}
              <div
                style={{
                  background: darkMode
              ...
              >
                ...
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold ml-4" style={{ color: darkMode ? 'white' : '#1f2937' }}>
                    {skill.name}
                  </h3>
                </div>
                ...
                {/* Divider + Gradient bar INSIDE the box */}
